define(['THREE', 'utils', 'jquery', 'database'], function (THREE, utils, $, database) {
    ...
    return {
        ...
        createLine: function (p1, p2, color) {
            ...
            // line.vertices.push(new THREE.Vector3(p1.x, p1.y, p1.z));
            // line.vertices.push(new THREE.Vector3(p2.x, p2.y, p2.z));
            // var g = new meshlines.MeshLine();
            // g.setGeometry(line);
            // var material = new meshlines.MeshLineMaterial({
            //     useMap: false,
